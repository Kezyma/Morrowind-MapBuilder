...
const string InputDir = @"D:\Repositories\Github\Morrowind-MapBuilder\worldmap_settlements";
const string OutputDir = @"D:\Repositories\Github\Morrowind-MapBuilder\Layers\Settlements";
//const string WaterTileName = "(-334,-164).png";
//const string FallbackName = "fallback_water.png";
...
//    waterImage.Mutate(x => x.Resize(TargetSize, TargetSize));
...
Parallel.ForEach(inputFiles, new ParallelOptions { MaxDegreeOfParallelism = Environment.ProcessorCount }, tilePath =>
{
    try
    {
        ...
        //if (tileHash.SequenceEqual(waterHash))
        //{
